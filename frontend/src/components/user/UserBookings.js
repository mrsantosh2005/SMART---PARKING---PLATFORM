...
import { FaQrcode, FaCar, FaMotorcycle, FaCalendarAlt, FaDollarSign, FaTimes } from 'react-icons/fa';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {bookings.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <a href="/parkings" className="inline-block bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700">
            Find Parking
          </a>
        </div>
      ) : (
